...
public class TimedHazardTrigger : MonoBehaviour
{
    ...
    [field: SerializeField] VisualEffect particleEffect;
    ...
    private void ToggleActiveState()
    {
        ...
        if (particleEffect.HasFloat("GasRate"))
        {
            if (particleEffect.GetFloat("GasRate") > 0)
            {
                particleEffect.SetFloat("GasRate", 0);
            }
            else particleEffect.SetFloat("GasRate", particleRate);
        }
    ...
    private void Start()
    {
        ...
        if (transform.childCount > 0 && affectParticles)
        {
            ...
            //  if (i > 2)
            {
                ...
                particleRate = particleEffect.GetFloat("GasRate");
                // }
                //}
            }
